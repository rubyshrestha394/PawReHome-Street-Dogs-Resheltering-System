...
if (isset($_GET['product_id'])) {
  ...
  $stmt = $conn->prepare("SELECT * FROM foradoption WHERE product_id= ? LIMIT 1");
      ...
      <?php while ($row = $product->fetch_assoc()) { ?>
        ...
        <div class="col-lg-6 col-md-12 col-12">
          ...
          <form method="POST" action="cart.php">
            ...
            <button class="buy-btn" type="submit" name="add_to_cart">Adopt Now</button>
          </form>
          <h4 class="mt-5 mb-5">Know your dog!</h4>
  ...
  <section id="related-products" class="my-5 pb-5">
    ...
    <div class="row mx-auto container-fluid">
      <div class="product text-center col-lg-3 col-md-4 col-sm-12">
        ...
        <h5 class="p-name">Dog Harness</h5>
      ...
      <div class="product text-center col-lg-3 col-md-4 col-sm-12">
        <img class="img-fluid mb-3" src="assets/imgs/product3.jpg" />
        <div class="star">
          <i class="fas fa-star"></i>
          <i class="fas fa-star"></i>
          <i class="fas fa-star"></i>
